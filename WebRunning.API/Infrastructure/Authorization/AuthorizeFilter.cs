...
namespace WebRunning.API.Infrastructure.Authorization
{
    public class AuthorizeFilter : AuthorizeAttribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            //    var controller_Resource = dbContext.Sys_Resources.Where(o => o.Code == controller+"Controller" && o.Type == Lib.Enums.ResourceType.Function).FirstOrDefault();
            //    var action_Resource = dbContext.Sys_Resources.Where(o => o.Code == action && o.ParentId == controller_Resource.Id && o.Type == Lib.Enums.ResourceType.Function).FirstOrDefault();
