...
namespace WebRunning.UnitTest.Services
{
    ...
    {               
        ...
        public async Task IsDupicateAttributesAsync(string Id, string UserName)
        {
            var service = await CreateServiceAsync();
            var result = await service.IsDupicateAttributesAsync(Guid.Parse(Id), UserName);
        ...
        #region Init Service
        private async Task<WebRunning.API.Service.Sys_Role.Service> CreateServiceAsync()
        {            
            ...
            return new WebRunning.API.Service.Sys_Role.Service(_context, _dateTimeProvider.Object, _userProvider.Object);
        }
